...
namespace Twirp\TwirpBundle\DependencyInjection\Compiler;
...
use Twirp\TwirpBundle\DependencyInjection\Twirp\ServiceDefinition;
use Twirp\TwirpBundle\DependencyInjection\Twirp\ServiceMethod;
...
class TwirpServicePass implements CompilerPassInterface
{
    ...
    {
        if (!$container->has('twirp.service_registry')) {
            return;
        }
